...
export const FillerProfilePicture = () => (
  <div className={"filmmakerFillerProfilePicture"}>?</div>
);
const ProfilePicture = ({ filmmaker, isSelected, setFilmmaker }) => {
  ...
  return (
    <div className={"filmmakerProfilePictureContainer"}>{profilePicture}</div>
  );
};

export const MemoizedProfilePicture = memo(
  ProfilePicture,
